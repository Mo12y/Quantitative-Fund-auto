...
PLAN_NAME = "1000元半年建仓计划"
START_DATE = "2026-08-24"  # 下周一
TOTAL_CAPITAL = 1000.0
CASH_RESERVE = 150.0  # 现金底仓（弹药）
...
FUNDS = [
    ...
    {
        "code": "016453",
        "name": "南方纳斯达克100(QDII)C",
        "role": "🌍 美股分散",
        "target_amount": 200.0,
        "target_pct": 20,
        "dca_daily": 10.0,  # 限购：每日最多买10元，只能每日定投
        "tranches": [
            {"date": "2026-08-24", "amount": 10.0},  # 之后每日10元
        ],
    },
    {
        "code": "007029",
...
# 温度联动规则
TEMP_RULES = {
    "cold": "温度<40°：把现金150元全部补进中证500和银河创新",
